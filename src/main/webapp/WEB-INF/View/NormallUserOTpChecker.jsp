...
<table class="table mt-5">
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td> ${normalluser.id }</td>
      <td> ${normalluser.userName }</td>
      <td>@ ${normalluser.email }</td>
    </tr>
  </tbody>
</table>
<c:if test="${ otp == null}">

 <form class="row g-3 m-auto offset-4" action="/normallusersignin" method="post">
  <div class="col-auto">
 ...
 <div class="d-grid gap-2">
  <button class="btn btn-primary" id="fee" onclick="feeOrder()" type="button">fee</button>
</div>
